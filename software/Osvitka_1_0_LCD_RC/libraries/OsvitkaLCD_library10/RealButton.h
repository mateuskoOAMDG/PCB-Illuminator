...
/*
 * 2023-04-14 - pridane metody onLongOne() onVLongOne() - generuju udalost pri prekroceni casu long, very long len 1x
 *
 * 
 */
#ifndef REALBUTTON_H
...
class RealButton : public DebounceButton {
    ...
    /// @brief Udalost sa generuje: V okamihu prekrocenia casu "longTime", po precitani udalosti treba zavolat onLongReset()
    /// @return  true - tlacitko bolo stlacene dlhsie ako longTime
    bool onLong();

    /// @brief Umozni, aby sa znova mohla vygenerovat udalost onLong(), volat po spracovani udalosti onLong()
    void longReset();
 ...
 private:
    ...
    uint8_t  _realState2; //dalsie statusy jednotlivych udalosti
